...
<% request.setCharacteerEncoding("utf-8"); %> 
...
<html><head><meta charset="utf-8"/><meta name="viewport" content="width=device-width, initial-scale=1"/> 
  ...
  <body><header><h2>실습을 환영합니다</h2></header> 
    <nav><ul class="ulClass"> 
      <li id="kdhong"><a .href="#kd">홍길동</a></li><liid="mrlee"><a .href="#mr">이몽룡</a></li> 
      ...
      <section id="Area"><form id="formld"> 
        <div id="div1" class="class1"> 
          ...
          <div id="div2" class="class1"> 
            ...
            <div id="div3"> <label id="id31" for="id32">전화 

            </label> <%= request.getParameter("sPhone")%>%>div> 
            <div id="div4">
